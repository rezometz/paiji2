...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field readers on 'Message'
        m2m_table_name = db.shorten_name(u'forum_message_readers')
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field readers on 'Message'
        db.delete_table(db.shorten_name(u'forum_message_readers'))
    ...
    models = {
        ...
        u'forum.message': {
            ...
            'readers': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'read_messages'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['rezo.User']"}),
