...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'User.id_rezo'
        db.alter_column(u'rezo_user', 'id_rezo', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'User.id_rezo'
        db.alter_column(u'rezo_user', 'id_rezo', self.gf('django.db.models.fields.PositiveIntegerField')(default=0))
    ...
    models = {
        ...
        u'rezo.user': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'id_rezo': ('django.db.models.fields.PositiveIntegerField', [], {'default': 'None', 'null': 'True'}),
