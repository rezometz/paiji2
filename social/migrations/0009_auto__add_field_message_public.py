...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'social_message', 'public',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'social_message', 'public')
    ...
    models = {
        ...
        u'social.post': {
            ...
            'bureau': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'members'", 'to': u"orm['social.Bureau']"}),
