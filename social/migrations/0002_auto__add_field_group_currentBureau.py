...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Group.currentBureau'
        db.add_column(u'social_group', 'currentBureau',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='associated_group', to=orm['social.Bureau']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Group.currentBureau'
        db.delete_column(u'social_group', 'currentBureau_id')
    ...
    models = {
        ...
        u'social.group': {
            ...
            'currentBureau': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'associated_group'", 'to': u"orm['social.Bureau']"}),
