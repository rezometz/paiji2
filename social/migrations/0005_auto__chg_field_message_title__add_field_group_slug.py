...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'social_message', 'title', self.gf('django.db.models.fields.CharField')(max_length=140))
        # Adding field 'Group.slug'
        db.add_column(u'social_group', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='to-complete', max_length=50),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Message.title'
        db.alter_column(u'social_message', 'title', self.gf('django.db.models.fields.TextField')(max_length=140))
        # Deleting field 'Group.slug'
        db.delete_column(u'social_group', 'slug')
    ...
    models = {
        ...
        u'social.message': {
            ...
            'poster': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'message'", 'to': u"orm['rezo.User']"}),
