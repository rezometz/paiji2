...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Group.calendar'
        db.add_column(u'social_group', 'calendar',
                      self.gf('django.db.models.fields.related.OneToOneField')(related_name='group', unique=True, null=True, to=orm['backbone_calendar.Calendar']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Group.calendar'
        db.delete_column(u'social_group', 'calendar_id')
