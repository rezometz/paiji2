...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Message.poster'
        db.delete_column(u'social_message', 'poster_id')

        # Adding field 'Message.author'
        db.add_column(u'social_message', 'author',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='message', to=orm['rezo.User']),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Message.poster'
        raise RuntimeError("Cannot reverse this migration. 'Message.poster' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Message.poster'
        db.add_column(u'social_message', 'poster',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='message', to=orm['rezo.User']),
                      keep_default=False)

        # Deleting field 'Message.author'
        db.delete_column(u'social_message', 'author_id')
